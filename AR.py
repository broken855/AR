#Open-Sourced By Abid Khan Akumaa.
...
def back():
        login()
def contact():
        os.system('xdg-open https://www.facebook.com/Abid Khanexeee')
        back()
def linex():
        print("""\x1b[37m----------------------------------------------""")
def cls():
...
def Abid Khanresults():
    ok_file_path = '/sdcard/Abid Khanv6/Abid Khanv6-OK.txt'
    cp_file_path = '/sdcard/Abid Khanv6/Abid Khanv6-CP.txt'
...
def contact():
        os.system('xdg-open https://www.facebook.com/Abid Khanexe')
...
if __name__=='__main__':
        try:os.mkdir('/sdcard/Abid Khanv6')
        except:pass
        try:os.mkdir('data')
        except:pass
